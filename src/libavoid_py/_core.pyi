...
class Router:
    ...
    def exists_orthogonal_segment_overlap(self, at_ends: bool = False) -> bool: ...
    def exists_orthogonal_fixed_segment_overlap(
        self, at_ends: bool = False
    ) -> bool: ...
    def exists_orthogonal_touching_paths(self) -> bool: ...
    def exists_crossings(
        self, optimised_for_connector_type: bool = False
    ) -> int: ...
    ...
    def delete_connector(self, connector: ConnRef) -> None: ...
...
class ShapeRef:
    ...
    def attached_connectors(self) -> list[ConnRef]: ...

class ConnDirFlag(IntEnum):
    ConnDirNone = 0
    ConnDirUp = 1
    ConnDirDown = 2
    ConnDirLeft = 4
...
class ConnEnd:
    ...
    @overload
    def __init__(self, point: Point, visibility_directions: int) -> None: ...
    def type(self) -> ConnEndType: ...
    def position(self) -> Point: ...
    def directions(self) -> int: ...

class ConnRef:
    @overload
    def __init__(self, router: Router, id: int = 0) -> None: ...
    @overload
    def __init__(
        self, router: Router, src: ConnEnd, dst: ConnEnd, id: int = 0
    ) -> None: ...
    def id(self) -> int: ...
    def set_endpoints(self, src: ConnEnd, dst: ConnEnd) -> None: ...
    def set_source_endpoint(self, src: ConnEnd) -> None: ...
    def set_dest_endpoint(self, dst: ConnEnd) -> None: ...
    def needs_repaint(self) -> bool: ...
    def display_route(self) -> PolyLine: ...
    def routing_type(self) -> ConnType: ...
    def set_routing_type(self, type: ConnType) -> None: ...
    def set_fixed_route(self, route: PolyLine) -> None: ...
    def set_fixed_existing_route(self) -> None: ...
    def has_fixed_route(self) -> bool: ...
    def clear_fixed_route(self) -> None: ...
    def endpoint_conn_ends(self) -> tuple[ConnEnd, ConnEnd]: ...
