"""Upstream ``cola/libavoid/tests/hyperedgeRerouting01.cpp``.

Phase 0's inventory flagged this test as needing hyperedges;
...
pytest.skip(
    "libavoid_py does not yet wrap hyperedges; "
